...
function Portfolio() {
    ...
    <aside>
        ...
        <hr></hr>
        <p>Our application was built on the basis that there is a need for youths to have a great mentor to teach them a trade and/or career. This application allows them to connect.</p>
        ...
        <hr></hr>
        <p>The project was created on the basis of a barter exchange application that allows the user to search items in a particular city and find them using an API called trash nothing</p>
        ...
        <hr></hr>
        <p>An employee directory using filters and search function built with React.</p> 
        ...
        <hr></hr>
        <p>Note taking application using express where a user can add notes or delete them.</p>
        ...
        <hr></hr>
        <p>E-commerce database backend using MySQL.</p>
        ...
        <hr></hr>
        <p>Weather forecast displayed of any city searched.</p>
