...
function About() {
    ...
    <hr></hr>        
        <p>
          ...
          I first learned of the basics HTML then how it is styled with CSS and now we are onto the much more complex node.JS, express, SQL, noSQL, MongoDB and React. 
